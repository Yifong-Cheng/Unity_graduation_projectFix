...
public class IKSnapTest : MonoBehaviour {
    #region Data
    [SerializeField]
    public Transform SingleObjChild;
    public Transform SingleObj;
    [SerializeField]
    ...
    Vector3 SingleObjChildPosition, SingleObjPosition;
    Quaternion SingleObjChildRotion;
    ...
    private void Awake()
    {
        ...
        //SingleObj = SingleObjChild.parent;
    }
    ...
    private void OnAnimatorIK(int layerIndex)
    {
        if (otherObj != null)
        {
            ...
            animator.bodyRotation = Quaternion.Lerp(transform.rotation,  Quaternion.LookRotation(targetPosition, Vector3.up), percentComplete);
        }
    ...
    {
        SingleObjChildPosition = SingleObjChild.position;
        SingleObjChildRotion = SingleObjChild.rotation;
        SingleObjPosition = SingleObj.position;
    }
