...
public abstract class FSMState
{
    ...
    /// </summary>
    public abstract void Reason(Transform player, AIController npc);
    ...
    /// NPC is a reference to the npc tha is controlled by this class
    /// </summary>
    public abstract void Act(Transform player, AIController npc);
    ...
    public void FindNextPoint()
    {
        ...
        int rndIndex = Random.Range(0, waypoints.Length-1);
