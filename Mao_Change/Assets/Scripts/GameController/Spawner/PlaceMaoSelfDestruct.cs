...
public class PlaceMaoSelfDestruct : MonoBehaviour
{
    ...
    IEnumerator DestroyNow()
    {
        ...
        GameObject go = Resources.Load<GameObject>("SceneObj/" + "Mao" + num);
        Instantiate(go, transform.position + new Vector3(0,-.5f,0), transform.rotation);
        Destroy(gameObject);
    }
}
